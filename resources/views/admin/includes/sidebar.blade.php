    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="{{ route('home') }}">
                <img src="{{ asset('/') }}website/assets/imgs/theme/logo.svg" class="header-brand-img desktop-logo"
                    alt="logo">
                <img src="{{ asset('/') }}website/assets/imgs/theme/logo.svg" class="header-brand-img toggle-logo"
                    alt="logo">
                <img src="{{ asset('/') }}website/assets/imgs/theme/logo.svg" class="header-brand-img light-logo"
                    alt="logo">
                <img src="{{ asset('/') }}website/assets/imgs/theme/logo.svg" class="header-brand-img light-logo1"
                    alt="logo">
            </a><!-- LOGO -->
        </div>
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Color</a></li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Size</a></li>
