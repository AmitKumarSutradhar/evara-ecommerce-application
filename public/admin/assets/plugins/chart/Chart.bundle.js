...
!function (t, e) {
            ...
            if (o) {
                ...
                if (a ? (t.width = this.maxWidth, t.height = Rs(n) + o) : (t.height = this.maxHeight, t.width = Rs(n) + o), i.display && this.ticks.length) {
                    const {
                            ...
                            widest: n,
                            highest: o
                        } = this._getLabelSizes(), r = 2 * i.padding, l = Et(this.labelRotation), h = Math.cos(l),
                        c = Math.sin(l);
                    if (a) {
        ...
        const e = Kn(t),
            ...
            o = function (t, e, i) {
                const {
                    ...
                    } = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius, o = Be(n), a = Math.min(e, i),
                    r = t.borderSkipped, l = s || U(n);
                return {
    ...
    function lo(t) {
        return (t.scale || {}).getPointPositionForValue ? function (t) {
            const {
                    scale: e,
                    fill: i
                } = t, s = e.options, n = e.getLabels().length, o = [], a = s.reverse ? e.max : e.min,
    ...
    class Ho extends Ss {
        ...
        getFooter(t, e) {
            const {
                    callbacks: i
                } = e, s = i.beforeFooter.apply(this, [t]), n = i.footer.apply(this, [t]),
